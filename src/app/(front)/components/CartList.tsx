...
export default function CartList() {
  ...
  if (items.length === 0) {
    return <div className="text-center mt-20 text-muted-foreground">ตะกร้าสินค้าว่างเปล่า...</div>
  }

  return (
    <div className="mx-auto max-w-4xl mt-20 px-6">
      <h1 className="font-heading text-2xl font-bold mb-6">ตะกร้าสินค้า</h1>
      <Table>
        <TableHeader>
            <TableRow>
